...
export default function QuestionBlob({ opA, opB, symbol, userA, correctA }) {
    ...
    return (
        <div className="bg-gray-800 m-3 rounded-lg p-3 h-28 flex flex-col justify-center items-center shadow-lg">
            ...
            {!isCorrect && (
                <h1 className="text-lg md:text-2xl text-gray-300 text-center mt-2">
