...
export default function About() {
    ...
    return (
        <section className="bg-gray-950 flex flex-col items-center p-8 font-mono">
            ...
            <h2 className="text-2xl lg:text-5xl font-bold text-white my-6 tracking-wide">
                Why <span className="text-orange-400">MathVenture?</span>
            </h2>
            <p className="text-sm lg:text-lg text-gray-300 max-w-4xl leading-relaxed font-mono mb-6">
            ...
            <p className="text-sm lg:text-lg text-gray-300 max-w-4xl leading-relaxed font-mono">
